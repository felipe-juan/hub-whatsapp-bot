...
const RESOURCE_CARDS = Object.freeze([
  {
    ...
    message: {
      ...
      response_text: [
        ...
        REPOSITORY_URLS.hub,
        '',
        '*Google Drive de veteranos*',
        'Possui materiais de vários semestres. Como alguns professores mudaram, confira sempre a disciplina, o docente e o período do arquivo.',
        REPOSITORY_URLS.drive,
        '',
        '*Google Drive da turma 2025.2*',
        'É mais atualizado, mas atualmente reúne materiais de apenas dois semestres.',
        REPOSITORY_URLS.drive,
        '',
        ...
        '',
        '_Observação: os dois Google Drives foram informados com o mesmo endereço._'
      ].join('\n'),
      priority: 97,
      active: true,
      archived: false,
